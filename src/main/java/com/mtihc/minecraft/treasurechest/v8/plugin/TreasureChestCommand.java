...
public class TreasureChestCommand extends SimpleCommand {
    ...
    public void setmessage(CommandSender sender, String[] args) throws CommandException {
        ...
        if (msgId == 1) {
            tchest.setMessage(ITreasureChest.Message.FOUND, message.toString());
        } else if (msgId == 2) {
            tchest.setMessage(ITreasureChest.Message.FOUND_ALREADY, message.toString());
        } else if (msgId == 3) {
            tchest.setMessage(ITreasureChest.Message.UNLIMITED, message.toString());
        } else {
